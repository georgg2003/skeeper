...
// docker/client tests transitively load grpc-gateway, which imports httpbody. Old genproto
// versions still ship googleapis/api/httpbody alongside genproto/googleapis/api — ambiguous.
// Pin the root genproto module to a release where those paths live only in the split modules.
